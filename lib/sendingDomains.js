...
module.exports = (client) => ({
     ...
     * @return {Promise}
     */
    list (subAccountOptions, callback) {
     ...
     * @return {Promise}
     */
    get (domain, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
     ...
     * @return {Promise}
     */
    create (createOpts, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
     ...
     * @return {Promise}
     */
    update (domain, updateOpts, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
     ...
     * @return {Promise}
     */
    delete (domain, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
     ...
     * @return {Promise}
     */
    verify (domain, options, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
