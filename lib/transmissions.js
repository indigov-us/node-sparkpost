...
module.exports = (client) => ({
     ...
     * @returns {Promise}
     */
    list (options, subAccountOptions, callback) {
     ...
     * @returns {Promise}
     */
    get (id, subAccountOptions, callback) {
      // Handle optional subAccountOptions argument
      if (typeof subAccountOptions === 'function') {
        callback = subAccountOptions
        subAccountOptions = {}
     ...
     * @returns {Promise}
     */
    send (transmission, options, subAccountOptions, callback) {
      // Handle optional options argument
      if (typeof options === 'function') {
        callback = options
        options = {}
...
function addListToRecipients(transmission, listName, headerTo) {
  ...
  return transmission.recipients.concat(
    _.map(transmission[listName], (recipient) => {
      recipient.address = addressToObject(recipient.address)
