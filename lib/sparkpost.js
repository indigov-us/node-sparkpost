...
SparkPost.prototype.request = (options, callback) => {
...
SparkPost.prototype.get = get
SparkPost.prototype.post = post

SparkPost.prototype.put = (options, callback) => {
  options.method = 'PUT'

  return this.request(options, callback)
}

SparkPost.prototype.delete = (options, callback) => {
  options.method = 'DELETE'

  return this.request(options, callback)
}

SparkPost.prototype.reject = (error, callback) => withCallback(Promise.reject(error), callback)
