...
describe('SparkPost Library', function () {
  ...
  describe('request method', function () {
    ...
    it('should make a request to the API', function (done) {
      nock('https://api.sparkpost.com').get('/api/v1/get/test').reply(200, { ok: true })
    ...
    it('should return an error if statusCode not 2XX', function (done) {
      // simulate a timeout
      nock('https://api.sparkpost.com').post('/api/v1/post/test/fail').reply(422, { errors: [] })
    ...
    it('should return an error if statusCode not 2XX and there is no body', function (done) {
      // simulate a timeout
      nock('https://api.sparkpost.com').post('/api/v1/post/test/fail').reply(422)
    ...
    it('should use a full URI if provided', function (done) {
      nock('https://test.sparkpost.com').get('/test').reply(200, { ok: true })
    ...
    it('should support explicitly disabled gzip option', function (done) {
      ...
      nock('https://test.sparkpost.com').get('/test').reply(200, { msg: TEST_MESSAGE })
  ...
  describe('post method', function () {
    ...
    it('should deliver a POST', function (done) {
      ...
      nock('https://api.sparkpost.com').post('/api/v1/post/test').reply(200, { ok: true })
    ...
    it('should return a parsed JSON object', function (done) {
      nock('https://test.sparkpost.com').post('/test').reply(200, '{ "ok": true }')
  ...
  describe('put method', function () {
    ...
    it('should deliver a PUT/UPDATE', function (done) {
      ...
      nock('https://api.sparkpost.com').put('/api/v1/put/test').reply(200, { ok: true })
    ...
    it('should return a parsed JSON object', function (done) {
      nock('https://test.sparkpost.com').put('/test').reply(200, '{ "ok": true }')
  ...
  describe('delete method', function () {
    ...
    it('should deliver a DELETE', function (done) {
      ...
      nock('https://api.sparkpost.com').delete('/api/v1/delete/test').reply(200, { ok: true })
    ...
    it('should return a parsed JSON object', function (done) {
      nock('https://test.sparkpost.com').delete('/test').reply(200, '{ "ok": true }')
